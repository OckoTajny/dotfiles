-- General settings (illogical-impulse defaults, Lua port of hyprland/general.conf)

-- Monitor fallback; per-output overrides live in monitors.lua
...
hl.config({
    ...
    general = {
        ...
        allow_tearing     = true, -- only enables the `immediate` window rule
    ...
    decoration = {
        ...
        -- Clean squircles look off; the extra .4 only makes rounding feel more continuous.
        rounding_power = 2,
        rounding       = 18,
