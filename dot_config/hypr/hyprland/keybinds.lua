...
-- (dotswap: freed CTRL+SUPER+SHIFT+right/left for profile cycling; use SUPER+ALT+Page_Up/Down to move windows across workspaces)
...
-- dotswap profile cycling
hl.bind("CTRL + SUPER + SHIFT + Right", hl.dsp.exec_cmd("~/.local/bin/dotswap-cycle next"))
hl.bind("CTRL + SUPER + SHIFT + Left", hl.dsp.exec_cmd("~/.local/bin/dotswap-cycle prev"))
hl.bind("CTRL + SUPER + P", hl.dsp.exec_cmd("~/.local/bin/dotswap use win11 && ~/.local/bin/dotswap-postapply win11"))
